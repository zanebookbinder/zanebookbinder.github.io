                    ...
                    <div className="accordions">
                                        ...
                                        <ul className="list-with-background">
                                            <li>
                                                <a
                                                    target="_blank"
                                                    rel="noreferrer"
                                                    href="https://tildesites.bowdoin.edu/~sbarker/teaching/courses/ds/21fall/"
                                                >
                                            ...
                                            <li>
                                                <a
                                                    target="_blank"
                                                    rel="noreferrer"
                                                    href="https://tildesites.bowdoin.edu/~ltoma/teaching/cs231/fall13/"
                                                >
                                            ...
                                            <li>
                                                <a
                                                    target="_blank"
                                                    rel="noreferrer"
                                                    href="https://tildesites.bowdoin.edu/~smajerci/teaching/cs2210/2019spring/index.html"
                                                >
                                                    CSCI 2210: Theory of
                                                    Computation (2022)
                                                </a>
                                            ...
                                            <li>
                                                <a
                                                    target="_blank"
                                                    rel="noreferrer"
                                                    href="https://tildesites.bowdoin.edu/~mirfan/CSCI-2320.html"
                                                >
                                                    CSCI 2320: Principles of
                                            ...
                                            <li>
                                                <a
                                                    target="_blank"
                                                    rel="noreferrer"
                                                    href="https://tildesites.bowdoin.edu/~sbarker/teaching/courses/systems/22fall/"
                                                >
                                                    CSCI 2330: Foundations of
                                                    Computer Systems (C, 2021)
                                                </a>
                                            </li>
                                            <li className="no-link">
                                                CSCI 2400: Artificial
                                                Intelligence (Python, 2022)
                                            </li>
                                            <li>
                                                <a
                                                    target="_blank"
                                                    rel="noreferrer"
                                                    href="https://tildesites.bowdoin.edu/~sbarker/teaching/courses/distributed/22spring/"
                                                >
                                                    CSCI 3325: Distributed
                                                    Systems (C/Java/Python,
                                                    2022)
                                                </a>
                                            </li>
                                            <li className="no-link">
                                                CSCI 3725: Computational
                                                Creativity
                                                (Python/Ruby/JS/Processing,
                                                2023)
                                            </li>
                                            <li className="no-link">
                                                CSCI 3465: Financial Machine
                                        ...
                                        <ul className="list-with-background">
                                            <li>
                                                <a
                                                    target="_blank"
                                                    rel="noreferrer"
                                                    href="https://www.milton.edu/academics/academic-departments/computer-science-courses/"
                                                >
                        ...
                        >
                            ...
                            <AccordionDetails>
                                <ul className="list-with-background">
                                    <li>
                                        Fall 2021: Algorithms Learning Assistant
                                        and Grader
                                    </li>
                                    <li>
                                        Spring 2022: Algorithms Learning
                                        Assistant and Grader
                                    </li>
                                    <li>
                                        Fall 2022: Foundations of Computer
                                        Systems Learning Assistant
                                    </li>
                                </ul>
                            </AccordionDetails>
                        </Accordion>
            ...
            <div className="bottom-columns">
                <div className="column">
                        ...
                        <ul>
                            <li>
                                <p>
                                    <span>
                                        <a
                                            href="https://www.bowdoin.edu/registrar/students/completing-degree/latin-honors-recipients.html"
                                            target="_blank"
                                            rel="noreferrer"
                                        >
                                            Graduated Cum Laude
                            ...
                            <li>
                                <p>
                                    <span>
                                        <a
                                            href="https://www.bowdoin.edu/about/prizes/general-scholarship.html"
                                            target="_blank"
                                            rel="noreferrer"
                                        >
                                    ...
                                    for academic and general excellence in
                            ...
                            <li>
                                <p>
                                    <span>
                                        <a
                                            href="https://www.bowdoin.edu/admissions/book-award/"
                                            target="_blank"
                                            rel="noreferrer"
                                        >
                                            Bowdoin Book Award
                            ...
                            <li>
                                <p>
                                    <span>
                                        <a
                                            href="https://www.bowdoin.edu/events/family-weekend/sarah-and-james-bowdoin-day.html"
                                            target="_blank"
                                            rel="noreferrer"
                                        >
                            ...
                            <li>
                                <p>
                                    <span>
                                        <a
                                            href="https://www.milton.edu/news/graduation-2020/"
                                            target="_blank"
                                            rel="noreferrer"
                                        >
                                            Graduated Cum Laude
                    ...
                    <div className="section">
                        ...
                        <ul>
                            <li>
                                <span>Proficient Spanish</span>
                            </li>
                            <ul>
                                <li>11 years of Spanish classes</li>
                                <li>
                                    Lived in Madrid with a Spanish family (June
                                    2018)
                                </li>
